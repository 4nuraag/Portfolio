...
`;
        ...
        class Simulation {
            ...
            update() {
                ...
                if (this.options.isViscous) {
                    if (this.viscous) vel = this.viscous.update({
                        viscous: this.options.viscous,
                ...
                let pressure;
                if (this.poisson) pressure = this.poisson.update({
        ...
        class Output {
            ...
            constructor() {
                this.simulation = new Simulation({}); // Initial empty options, will be set
                this.scene = new THREE.Scene();
                this.camera = new THREE.Camera();
        ...
        class WebGLManager {
            ...
            init() {
                ...
                webglRef.current = this; // Fix for simulation option access
            }
            resize() {
                Common.resize();
        ...
        // Fix: We need to set webglRef.current BEFORE applyOptionsFromProps but WebGLManager init needs props
        // Correct order: Create WebGLManager -> it sets webglRef -> applyOptions -> start
        ...
        // webglRef.current = webgl; // Done in WebGLManager.init/constructor
